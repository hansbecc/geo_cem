...
COPY . /usr/src/geo_cem/
WORKDIR /usr/src/geo_cem
...
RUN chmod +x /usr/src/geo_cem/tasks.py \
    && chmod +x /usr/src/geo_cem/entrypoint.sh
...
ENTRYPOINT /usr/src/geo_cem/entrypoint.sh
